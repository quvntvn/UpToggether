const en = {
  ...
  homeTab: {
    ...
    streak: 'STREAK',
    streakValueOne: '{{count}} day',
    streakValueOther: '{{count}} days',
  ...
  progressTab: {
    ...
    historyBodyOne: '{{count}} recorded wake session.',
    historyBodyOther: '{{count}} recorded wake sessions.',
    badgesTitle: 'Badges',
    badgesBody: '{{unlocked}}/{{total}} unlocked · {{percent}}% complete.',
