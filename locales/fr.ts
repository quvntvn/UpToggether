const fr = {
  ...
  homeTab: {
    ...
    streak: 'SÉRIE',
    streakValueOne: '{{count}} jour',
    streakValueOther: '{{count}} jours',
  ...
  alarmsTab: {
    ...
    helperText: 'Gère tes programmations et reste synchronisé avec ton squad.',
  ...
  progressTab: {
    ...
    historyBodyOne: '{{count}} session enregistrée.',
    historyBodyOther: '{{count}} sessions enregistrées.',
    badgesTitle: 'Badges',
    badgesBody: '{{unlocked}}/{{total}} débloqués · {{percent}}% complété.',
